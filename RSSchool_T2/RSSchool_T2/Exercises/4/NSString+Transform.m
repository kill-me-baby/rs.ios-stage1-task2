...
-(BOOL)isPangram:(NSString*)inputString {
    ...
    //Convert uppercaseInputString from string to array
...
-(NSDictionary*)getDictIfPangram:(NSString*)input {
    ...
    if (pangram) {
        ...
        NSDictionary* vowels = @{@"a" : @"A", @"e" : @"E", @"i" : @"I",
                                 @"o" : @"O", @"u" : @"U", @"y" : @"Y"};
        
        return vowels;
    } else {
        
        NSDictionary* consonants = @{@"b" : @"B", @"c" : @"C", @"d" : @"D", @"f" : @"F", @"g" : @"G",
                                     @"h" : @"H", @"j" : @"J", @"k" : @"K", @"l" : @"L", @"m" : @"M",
                                     @"n" : @"N", @"p" : @"P", @"q" : @"Q", @"r" : @"R", @"s" : @"S",
                                     @"t" : @"T", @"v" : @"V", @"w" : @"W",
                                     @"x" : @"X", @"z" : @"Z"};
...
-(NSString*)transform {
    ...
    //MARK:- Get newWord
    //Example: oldWord = word, newWord = 1wOrd
    ...
    newWord = ^(NSString* word) {
        ...
        //Convert word from string to array
    ...
    //MARK:- Sort of words from min to max and get result
